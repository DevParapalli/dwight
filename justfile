...
# Technical deep dive, typeset with Centauri (the print half of Proxima).
# Needs the centauri checkout beside this one; --root spans both so the import
# resolves, and its fonts must be on the path or page breaks shift.
